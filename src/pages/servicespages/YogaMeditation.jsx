...
const YogaMeditation = () => {
  ...
  const programs = [
    {
      title: t("yoga_program_morning_title"),
      description: t("yoga_program_morning_desc"),
    },
    {
      title: t("yoga_program_guided_title"),
      description: t("yoga_program_guided_desc"),
    },
    {
      title: t("yoga_program_power_title"),
      description: t("yoga_program_power_desc"),
    },
    {
      title: t("yoga_program_chair_title"),
      description: t("yoga_program_chair_desc"),
    },
    {
      title: t("yoga_program_retreats_title"),
      description: t("yoga_program_retreats_desc"),
    },
    {
      title: t("yoga_program_breathing_title"),
      description: t("yoga_program_breathing_desc"),
    },
  ];
  ...
  const features = [
    t("yoga_feature_app"),
    t("yoga_feature_routines"),
    t("yoga_feature_ondemand"),
    t("yoga_feature_guides"),
  ];
    ...
    >
      ...
      <section className="relative flex items-center justify-center w-full h-screen max-w-full px-4 overflow-hidden sm:px-6 md:px-8 lg:px-16">
        ...
        <div className="relative z-10 w-full max-w-4xl px-4 text-center">
          ...
          >
            {t("yoga_hero_title1")}{" "}
            <span className="text-teal-500">{t("yoga_hero_title2")}</span>
          </h1>
          <p
      ...
      >
        <div className="w-full mx-auto overflow-hidden max-w-7xl">
          ...
          >
            ...
            >
              {t("yoga_benefits_title1")}{" "}
              <span className="text-[#26A0A2]">
                {t("yoga_benefits_title2")}
              </span>
            </h2>
            <p
          ...
          <div className="grid items-center grid-cols-1 gap-6 lg:grid-cols-3 sm:gap-8">
            ...
            >
              ...
              >
                {t("yoga_benefit_transform_title")}
              </h3>
              <p
      ...
      >
        ...
        <div className="relative z-10 w-full mx-auto overflow-hidden max-w-7xl">
          <div className="mb-12" data-aos="fade-up">
            ...
            >
              {t("yoga_programs_title1")}{" "}
              <span className="text-white">{t("yoga_programs_title2")}</span>
            </h2>
          </div>
          ...
          <div className="grid items-stretch grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            >
              <div>
                ...
                >
                  {t("yoga_how_title1")}{" "}
                  <span className="text-[#26A0A2]">{t("yoga_how_title2")}</span>
                </h2>
                <p
              ...
              <div>
                <h2 className="mb-6 text-3xl font-bold text-white sm:text-4xl md:text-5xl">
                  <span className="text-white">
                    {t("yoga_features_title1")}
                  </span>{" "}
                  {t("yoga_features_title2")}
                </h2>
                <p className="mb-8 text-lg text-white sm:text-xl">
                  {t("yoga_features_desc")}
                </p>
              </div>
            ...
            >
              {features.map((feature, index) => (
                ...
                >
                  ...
                  >
                    {t("yoga_feature_card_desc", { feature })}
                  </p>
                </div>
              ))}
            </div>
              ...
              <div className="bg-gradient-to-br from-[#26A0A2] to-[#20c997] rounded-2xl p-6 border-2 border-[#26A0A2] transform scale-105">
                ...
                <ul className="mb-6 space-y-3 text-left text-white">
                  ...
                  >
                    ...
                    {t("yoga_pricing_premium_feature1")}
                  </li>
                  <li
                    className="flex items-center"
                    data-aos="fade-right"
                  ...
                  >
                    ...
                    {t("yoga_pricing_premium_feature2")}
                  </li>
                  <li
                    className="flex items-center"
                    data-aos="fade-right"
                  ...
                  >
                    ...
                    {t("yoga_pricing_premium_feature3")}
                  </li>
                  <li
                    className="flex items-center"
                    data-aos="fade-right"
                  ...
                  >
                    ...
                    {t("yoga_pricing_premium_feature4")}
                  </li>
                  <li
                    className="flex items-center"
                    data-aos="fade-right"
                  ...
                  >
                    ...
                    {t("yoga_pricing_premium_feature5")}
                  </li>
                </ul>
                <button
